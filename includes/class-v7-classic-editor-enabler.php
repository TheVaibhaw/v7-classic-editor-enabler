...
class V7_Classic_Editor_Enabler
{
     ...
     * @since    1.0.0
     * @access   protected
     * @var      V7_Classic_Editor_Enabler_Loader    $loader    Maintains and registers all hooks for the plugin.
     */
    protected $loader;
     ...
     *
     * - V7_Classic_Editor_Enabler_Loader. Orchestrates the hooks of the plugin.
     * - V7_Classic_Editor_Enabler_i18n. Defines internationalization functionality.
     * - V7_Classic_Editor_Enabler_Admin. Defines all hooks for the admin area.
     * - V7_Classic_Editor_Enabler_Public. Defines all hooks for the public side of the site.
     *
     ...
     *
     * Uses the V7_Classic_Editor_Enabler_i18n class in order to set the domain and to register the hook
     * with WordPress.
     *
     * @since    1.0.0
     * @access   private
    ...
    private function define_public_hooks()
    {
        ...
        // Disable block editor based on settings
